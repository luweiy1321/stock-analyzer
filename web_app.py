...
# 默认自选股 (用纯代码)
DEFAULT_WATCHLIST = [
    "000001", "600519", "600036", "600900", "601318", "300750", "300059", "600410", "002185", "002009"
]

# 股票代码到市场的映射（常用股票）
STOCK_MARKET_MAP = {
    # 沪市 (6开头)
    "600000": "SH", "600036": "SH", "600519": "SH", "600900": "SH", "600410": "SH", "601318": "SH", "601888": "SH", "600016": "SH", "600030": "SH", "600031": "SH", "600887": "SH",
    # 科创板 (688开头)
    "688981": "SH", "688111": "SH", "688036": "SH", "688008": "SH", "688005": "SH", "688399": "SH", "688001": "SH", "688169": "SH", "688328": "SH", "688027": "SH", "688066": "SH",
    # 深市主板 (000, 001开头)
    "000001": "SZ", "000002": "SZ", "000063": "SZ", "000333": "SZ", "000651": "SZ", "000858": "SZ", "000725": "SZ", "000001": "SZ",
    # 创业板 (300开头)
    "300750": "SZ", "300059": "SZ", "300015": "SZ", "300033": "SZ", "300122": "SZ", "300124": "SZ", "300347": "SZ", "300308": "SZ", "300364": "SZ", "300251": "SZ", "300666": "SZ",
    # 中小板 (002开头)
    "002594": "SZ", "002475": "SZ", "002185": "SZ", "002009": "SZ", "002230": "SZ", "002050": "SZ", "002027": "SZ", "002044": "SZ", "002371": "SZ", "002415": "SZ", "002049": "SZ", "002456": "SZ", "002736": "SZ",
}
...
with st.sidebar:
    ...
    # 添加自选股
    st.subheader("➕ 添加股票")
    new_stock = st.text_input("输入股票代码", placeholder="如: 600519 或 300750")
    if st.button("添加"):
        if new_stock and new_stock not in watchlist:
            # 自动检测市场
            full_code = detect_market(new_stock)
            watchlist.append(new_stock)
            save_watchlist(watchlist)
            st.success(f"已添加 {full_code}")
            st.rerun()
    ...
    # 也支持手动输入
    manual_input = st.text_input("或手动输入代码", placeholder="如: 600519")
    if manual_input:
...
if 'df' in st.session_state:
    ...
    full_code = st.session_state.get('full_code', stock_code)
